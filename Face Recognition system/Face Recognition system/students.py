...
class Student:
    def __init__(self,root):
        ...
        img = Image.open(r"C:\Users\user\OneDrive\Desktop\Apoorv\college_images\face_det.png")
        ...
        # SECOND IMAGE
        img1 = Image.open(r"C:\Users\user\OneDrive\Desktop\Apoorv\college_images\gettyimages-1022573162.jpg")
        ...
        # THIRD IMAGE
        img2 = Image.open(r"C:\Users\user\OneDrive\Desktop\Apoorv\college_images\face-recognition.png")
        ...
        img4 = Image.open(r"C:\Users\user\OneDrive\Desktop\Apoorv\college_images\register.png")
        ...
        img5 = Image.open(r"C:\Users\user\OneDrive\Desktop\Apoorv\college_images\university2.jpg")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get()=="Select Course"  or self.var_year.get()=="Select Year" or self.var_sem.get()=="Select Semester" or self.var_id.get()=="" or self.var_name.get()=="" or self.var_phone.get()=="":
            ...
            try:    
                conn =mysql.connector.connect(host="localhost",username="root",password="apoorv@123",database="face_recognition")
