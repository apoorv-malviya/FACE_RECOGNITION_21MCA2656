...
class Face_Recognition:
    def __init__(self,root):
        ...
        # TOP IMAGE
        img1 = Image.open(r"C:\Users\user\OneDrive\Desktop\Apoorv\college_images\face_detector1.jpg")
        img1 = img1.resize((700,755),Image.ANTIALIAS)
        self.photoimg1 = ImageTk.PhotoImage(img1)
        f_lbl = Label(self.root,image=self.photoimg1)
        f_lbl.place(x=0,y=36,width=700,height=755)
        
        img2 = Image.open(r"C:\Users\user\OneDrive\Desktop\Apoorv\college_images\facial_recognition_system_identification_digital_id_security_scanning_thinkstock_858236252_3x3-100740902-large.jpg")
        img2 = img2.resize((835,755),Image.ANTIALIAS)
        self.photoimg2 = ImageTk.PhotoImage(img2)
        f_lbl = Label(self.root,image=self.photoimg2)
        f_lbl.place(x=701,y=36,width=835,height=755)
        
        b1_button=Button(f_lbl,text="DETECT FACE",command=self.face_recog,cursor="hand2",font=("times new roman",15,"bold"),fg="white",bg="darkblue",bd=2,highlightbackground="white",highlightthickness = 2)
