...
class Face_Recognnition_System:
    def __init__(self,root):
        ...
        img = Image.open(r"C:\Users\user\OneDrive\Desktop\Apoorv\college_images\unnamed.jpg")
        ...
        # SECOND IMAGE
        img1 = Image.open(r"C:\Users\user\OneDrive\Desktop\Apoorv\college_images\facialrecognition.png")
        ...
        # THIRD IMAGE
        img2 = Image.open(r"C:\Users\user\OneDrive\Desktop\Apoorv\college_images\unnamed.jpg")
        ...
        # bg image
        img3 = Image.open(r"C:\Users\user\OneDrive\Desktop\Apoorv\college_images\img3.jpg")
        img3 = img3.resize((1600,710),Image.ANTIALIAS)
        self.photoimg3 = ImageTk.PhotoImage(img3)
        bg_img = Label(self.root,image=self.photoimg3)
        bg_img.place(x=0,y=130,width=1600,height=710)
        
        title_lbl = Label(bg_img,text="FACE RECOGNITION ATTENDENCE SYSTEM",font=("times new roman",30,"bold"),bg="white",fg="darkblue")
        # place is used to place anything
        title_lbl.place(x=0,y=0,width=1530,height=45)
        
        
        #STUDENT DETAIL SECTION 
        img4 = Image.open(r"C:\Users\user\OneDrive\Desktop\Apoorv\college_images\iStock-182059956_18390_t12.jpg")
        ...
        # DETECT FACE
        img5 = Image.open(r"C:\Users\user\OneDrive\Desktop\Apoorv\college_images\face_detector1.jpg")
        ...
        # TRAIN DATA
        img6 = Image.open(r"C:\Users\user\OneDrive\Desktop\Apoorv\college_images\train.png")
        ...
        # SAMPLE COLLECTED
        img7 = Image.open(r"C:\Users\user\OneDrive\Desktop\Apoorv\college_images\img2.jpg")
